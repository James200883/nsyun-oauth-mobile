...
export class ForgotPassPage {
  ...
  constructor (private viewCtrl: ViewController, private navCtrl: NavController, private http: Http, private formBuilder: FormBuilder, private commonService: CommonServices) {
